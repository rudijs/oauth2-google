...
describe('oauth2-google', function () {
    describe('get-profile', function () {
        ...
        it('should return a valid google plus user profile', function (done) {
            ...
            getProfile(config, fixtureGetTokens).then(function (res) {
        ...
        it('should handle get Google Plus User errors', function (done) {
            ...
            getProfile(config, fixtureGetTokens).catch(function (err) {
